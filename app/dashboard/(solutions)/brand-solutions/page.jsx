  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-2xl h-[90vh] overflow-y-scroll">
        <h2 className="text-2xl font-bold mb-4">Edit Brand Solutions</h2>
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            {formData.brand?.map((brand, index) => (
              <div key={brand._id || index} className="relative border border-gray-200 rounded-lg">
                <Image
